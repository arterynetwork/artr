...
func (s *StatusUpgradeSuite) SetupTest() {
	...
	s.heads[0] = accAddr("artrt1847dh25pq47cysckpa05lh7yt7ckuqs88c9438")
	s.heads[1] = accAddr("artrt1ykm27k4ju4whlmre776s9s55gjscvvrfxxguta")
	s.heads[2] = accAddr("artrt1utkd2et99v496k973qvpgn7w6d6zr83fa6j72r")
}
...
func (s *Status3x3Suite) TestStatusDowngrade_3x3() {
	genesisTime := s.ctx.BlockTime()
	const (
		root   = "artrt1yhy6d3m4utltdml7w7zte7mqx5wyuskqppw34n"
		neck00 = "artrt18mrcvv6qkmkx5uyjxy4lpl5fh7w08wgfwl4ehs"
		neck02 = "artrt1d8gc7e2mftlcgjgejtluw9uqem88jzj4qxqr24"
	)
